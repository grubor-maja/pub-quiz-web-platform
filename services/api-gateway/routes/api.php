...
Route::get('/circuit-breaker/status', [CircuitBreakerController::class, 'status']);
Route::get('/circuit-breaker/status/{service}', [CircuitBreakerController::class, 'serviceStatus']);
