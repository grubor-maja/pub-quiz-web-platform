...
function LoadingDragon() {
  ...
  const dragonSvg2 = 'data:image/svg+xml;base64,'
  ...
  return (
    <div className="loading-dragon">
      ...
      <div className="loading-text">
        ...
        <span style={{ color: 'rgba(228, 230, 234, 0.8)', marginLeft: '8px' }}>se učitava...</span>
      </div>
    </div>
  )
}
